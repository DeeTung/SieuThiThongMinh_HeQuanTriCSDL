-- ==========================================================
-- SMART SUPERMARKET - STORE PORTAL
-- KhoiTaoCacBang.sql
-- Fixed schema version for GitHub push
-- Notes:
...
-- Test lostupdate --
CREATE TABLE DEMO_LOST_UPDATE_LOG (
    LOG_ID          VARCHAR2(50) PRIMARY KEY,
    EMPLOYEE_ID     VARCHAR2(50),
    STORE_ID        VARCHAR2(50),
    PRODUCT_ID      VARCHAR2(50),
...
CREATE INDEX IDX_ODT_ORDER ON ORDER_DETAILS_TEMP(order_id);
